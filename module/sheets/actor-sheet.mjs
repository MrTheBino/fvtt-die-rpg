 ...
 * @extends {ActorSheet}
 */
export class DieRpgActorSheet extends ActorSheet {
  /** @override */
  ...
  /** @override */
  get template() {
    return `systems/fvtt-die-rpg/templates/actor/actor-${this.actor.type}-sheet.hbs`;
  }
  ...
  _prepareItems(context) {
    ...
    for (let i of context.items) {
      ...
      else if (i.type === 'classFeatureGod') {
        classFeatureGods.push(i);
      }
